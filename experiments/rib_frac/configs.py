...
class configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.root_dir = '/mnt/nas5_backup/fmo/01-workspace/medicaldetectiontoolkit/data/'
        self.gt_file = '{}/RibFrac_Public_GT.json'.format(self.root_dir)
        self.raw_data_dir = '{}/RibFrac_nii'.format(self.root_dir)
        ...
        self.pp_name = 'RibFrac_pp'
        self.input_df_name = 'info_df.pickle'
        self.pp_data_path = '/mnt/nas5_backup/fmo/01-workspace/medicaldetectiontoolkit/data/{}'.format(self.pp_name)
